...
FlowColorTokens flowColorsFor(AppBackgroundTheme theme) {
  return switch (theme) {
    ...
    AppBackgroundTheme.quoteflowGlow => const FlowColorTokens(
      background: Color(0xFF18262E),
      surface: Color(0xCC24343A),
      elevatedSurface: Color(0xD1304348),
      textPrimary: Color(0xFFFFF4E7),
      textSecondary: Color(0xC5D3D9CF),
      accent: Color(0xFFF0C592),
      divider: Color(0x49B0C6BC),
      quoteFrame: Color(0xA62A3C42),
      quoteFrameBorder: Color(0x76E5C9A7),
      quoteFrameGlow: Color(0x41D0AF8F),
      interactionRipple: Color(0x6EF2D1A9),
    ),
  };
}
